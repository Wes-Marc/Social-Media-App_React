...
function HomeGuest() {
    ...
    // Axios request to check unique username
    useEffect(() => {
    ...
    // Axios request to check unique email
    useEffect(() => {
    ...
    // Axios request to check Register User
    useEffect(() => {
